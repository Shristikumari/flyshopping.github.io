    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="#"><img class="main-logo" src="img/logo/fly.png" alt="" /></a>
                <strong><img src="img/logo/fly.png" alt="" /></strong>
            </div>
			<div class="nalika-profile">
				<div class="profile-dtl">
					<a href="#"><img src="img/notification/4.jpg" alt="" /></a>
					<h2>Shristi<span class="min-dtn">Jha</span></h2>
				</div>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="has-arrow" href="#">
								   ...
								   <span class="mini-click-non">Catalog</span>
								</a>
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Add product" href="ProductAdd.php"><span class="mini-sub-pro">Add Product</span></a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="logo-pro">
                  <a href="#"><img class="main-logo" src="img/logo/logosn.png" alt="" />
                    </div>
                </div>
            </div>
        </div>
...
<li><a data-toggle="tab" href="#Projects">Activity</a>
 ...
 <form method="post" class="form-horizontal"  enctype="multipart/form-data" style="border-radius:5px;">
<fieldset>
<!-- Form Name -->
<legend>&nbsp&nbsp&nbsp&nbspPRODUCTS</legend>

<!-- Text input-->
  <label class="col-md-4 control-label" for="product_id">PRODUCT ID</label>  
  <div class="col-md-4">
  <input id="product_id" name="prd_id" class="form-control input-md" required="" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="product_name" name="product_name"  class="form-control input-md"  type="text">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="product_name" name="desc" class="form-control input-md" type="text">
...
<!----text input--->
<div class="form-group">
  <label class="col-md-4 control-label" for="product_categorie">PRODUCT COLOR</label>
  <div class="col-md-4">
    <select id="product_categorie" name="col" class="form-control">
        <option name="one">Red</option>
        <option name="two">Blue</option>      
        <option name="three">Green</option>
        <option name="four">Yellow</option>
        <option name="five">Black</option>
...
<!----TEXT INPUT---->
<div class="form-group">
  <label class="col-md-4 control-label" for="product_categorie">PRODUCT SIZE</label>
  <div class="col-md-4">
    <select id="product_categorie" name="size" class="form-control">
        <option name="one">XS</option>
        <option name="two">S</option>      
        <option name="three">M</option>
        <option name="four">L</option>
        <option name="five">Free</option>
...
<label class="col-md-4 control-label" for="available_quantity">AVAILABLE QUANTITY</label>  
  <div class="col-md-4">
<input id="available_quantity" name="prd_quantity" class="form-control input-md"  type="text">
...
<!-- Textarea -->
<div class="form-group">
  <label class="col-md-4 control-label" for="product_name_fr">PRODUCT Full DESCRIPTION</label>
  <div class="col-md-4">                     
    <textarea class="form-control" id="product_name_fr" name="prd_full"></textarea>
  </div>
</div>

<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="percentage_discount">PRODUCT DISCOUNT</label>  
  <div   class="col-md-4">
  <input id="percentage_discount" name="prd_dis" class="form-control input-md"  type="text">
...
<!---<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="stock_alert" name="stock_alert" class="form-control input-md" required="" type="text">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="online_date">PRODUCT DISCOUNT START_DATE</label>  
  <div class="col-md-4">
  <input id="online_date" name="start_date" class="form-control input-md" type="text">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="online_date">PRODUCT DISCOUNT END_DATE</label>  
  <div class="col-md-4">
  <input id="online_date" name="end_date" class="form-control input-md" type="text">
...
<!---<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="enable_display" name="enable_display" class="form-control input-md" required="" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <input type="submit" id="singlebutton" name="button" class="btn btn-primary">
  </div>
  </div>
...
{
    echo $prd_id=$_POST['prd_id'];
 echo $prd_name=$_POST['product_name'];
 echo $Prd_Description=$_POST['desc'];
echo $prd_catagory=$_POST['cat'];
echo $prd_color=$_POST['col'];
echo $prd_size=$_POST['size'];
echo $prd_quantity=$_POST['prd_quantity'];
echo $prd_full_desc=$_POST['prd_full'];
echo $prd_discount=$_POST['prd_dis'];
echo $prd_dis_start_date=$_POST['start_date'];
echo $prd_dis_end_date=$_POST['end_date'];
echo $image=$_FILES['file']['name'];
echo $temp=$_FILES['file']['tmp_name'];
move_uploaded_file($temp,'flyimage/'.$image);

 $query="INSERT INTO product set prd_id='$prd_id',prd_name  = '$prd_name', prd_disc ='$Prd_Description',
 prd_color='$prd_color',prd_size='$prd_size',prd_discount='$prd_discount',
 prd_quantity='$prd_quantity',
 prd_full_disc='$prd_full_desc',prd_dis_start_date='$prd_dis_start_date',
 prd_dis_end_date='$prd_dis_end_date',prd_image='$image'";
